...
namespace itcast.CRM15.IServices
{
    ...
    public interface IBaseServices<TEntity> where TEntity : class
    {
        ...
        //List<TEntity> QUeryOrderByDescending<Tkey>(Expression<Func<TEntity, bool>> where, Expression<Func<TEntity, bool>> order);
        /// <summary>
        /// 分页方法
        /// </summary>
        ...
        //void Delete(TEntity model, bool isAdder);
